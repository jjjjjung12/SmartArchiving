...
public class UserAuthApplyDetailRowDto {
	...
	public String getBussinessNm() { return bussinessNm; }
	public void setBussinessNm(String bussinessNm) { this.bussinessNm = bussinessNm; }
