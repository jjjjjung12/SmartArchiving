...
<% request.setAttribute("pageTitle", "modalSabun"); %>
<div class="popup_wrap_inner">
	<div class="pop_header"><h3 class="tit_pop">modalSabun</h3></div>
...
<script src="${pageContext.request.contextPath}/js/user/modalSabun.js"></script>
