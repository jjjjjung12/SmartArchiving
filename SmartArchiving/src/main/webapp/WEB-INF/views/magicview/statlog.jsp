...
<% request.setAttribute("pageTitle", "통계 로그 조회"); request.setAttribute("menuFolded", Boolean.TRUE); %>
...
<script src="${pageContext.request.contextPath}/js/magicview/statlog.js"></script>
