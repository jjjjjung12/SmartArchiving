...
<div class="box_option">
	<ul class="option_list">
		...
		<li><a href="javascript:void(0)" id="btnMasking" class="btn grey mid">마스킹 해제</a></li>
...
<script src="${pageContext.request.contextPath}/js/magicview/transactionIlogIpBand.js"></script>
