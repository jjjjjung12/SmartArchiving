...
<% request.setAttribute("pageTitle", "결재"); %>
	...
	<div class="master-panel">
		...
		<div class="tbl_box mt10">
			<table class="tbl02 txthover"><thead><tr>
				<th>요청ID</th><th>요청구분</th><th>요청사유</th><th>부서명</th>
				<th>요청자</th><th>요청일자</th><th>결재일자</th><th>결재상태</th>
...
<script src="${pageContext.request.contextPath}/js/approve/userApproveProc.js"></script>
