...
<% request.setAttribute("pageTitle", "delete 작업 이력"); %>
<div class="box_option">
	<ul class="option_list">
		...
		<li><strong>작업명</strong><input type="text" id="C_JOB_NM" style="width:97%; height:30px;" placeholder=" 작업명을 입력하세요."/></li>
...
<div class="master-detail mt32">
	...
	<div class="detail-panel">
		...
		<dl class="input_box"><dt><label for="f_name">메세지</label></dt><dd><input type="text" id="F_JOB_MSG"  readonly /></dd></dl>
		</div>
		<input type="hidden" id="CRUD" value="C"/>
		<input type="hidden" id="ROWID" value=""/>
	</div>
</div>
<script src="${pageContext.request.contextPath}/js/job/deleteJobHistory.js"></script>
