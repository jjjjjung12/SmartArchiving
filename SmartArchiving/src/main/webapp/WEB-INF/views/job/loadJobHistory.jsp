...
<% request.setAttribute("pageTitle", "로드 작업 이력"); %>
...
<div class="master-detail mt32">
	...
	<div class="detail-panel">
		...
		<dl class="input_box"><dt><label for="f_name">메세지</label></dt><dd><input type="text" id="F_SCAN_MSG"  readonly /></dd></dl>
		</div>
		<input type="hidden" id="CRUD" value="C"/>
		<input type="hidden" id="ROWID" value=""/>
	</div>
</div>
<script src="${pageContext.request.contextPath}/js/job/loadJobHistory.js"></script>
