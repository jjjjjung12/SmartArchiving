...
<% request.setAttribute("pageTitle", "배치작업목록"); %>
<div class="box_option">
	<ul class="option_list">
		...
		<li><a href="javascript:void(0)" id="btnEdit" class="btn grey mid">편집</a></li>
	</ul>
</div>
<div class="master-detail mt32">
	...
	<div class="detail-panel">
		...
		<dl class="input_box"><dt><label for="f_name">작업코드</label></dt><dd><input type="text" id="F_JOB_ID" /></dd></dl>
...
<script src="${pageContext.request.contextPath}/js/job/onDemandList.js"></script>
