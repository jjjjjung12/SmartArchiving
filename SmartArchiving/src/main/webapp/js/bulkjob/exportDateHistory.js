...
$(function(){
	var grid = ArchiveGrid.create({
		...
		columns: [
			...
			{name:'DES_JOBFILE', align:'left'},
			{name:'JOB_STTS', hidden:true},
			{name:'JOB_MSG', hidden:true},
			{name:'JOB_TYPE', hidden:true},
			{name:'SRC_DATA_ROWS', hidden:true},
			{name:'DES_DATA_ROWS', hidden:true},
		],
...
$(document).ready(function() {
	...
	function loadInfo(selectedRow, currentRow, currentPage) {
        ...
        $('#F_DES_JOBFILE').val(selectdRow.DES_JOBFILE);
