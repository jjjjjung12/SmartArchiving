...
$(document).ready(function() {
	...
	$('#btnEnc').click(function (e) {
		...
		console.log("btn btnEnc.........");
		console.log("searchDataLen........." + $('#F_INPUT_TEXT').val().length );
		console.log("searchData........." + $('#F_INPUT_TEXT').val() );
		       
		
		var Obj = new Object();		
		Obj.__F_INPUT_TEXT    = $('#F_INPUT_TEXT').val();
		Obj.__TYPE = "ENC";
		...
		$.ajax({
			...
			success: function(json_data) {
		        ...
		        if(json_data.result == 'OK') {		        	
			        $('#F_RST_ENC').val(json_data.OUTPUT);			      			        
